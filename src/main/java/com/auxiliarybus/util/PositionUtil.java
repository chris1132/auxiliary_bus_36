...
public class PositionUtil {
    ...
    public static Gps gcj02_To_Bd09_gps(Gps gps) {
        return gcj02_To_Bd09(gps.wgLon, gps.wgLat);
    }
    ...
    public static void main(String[] args) {
        Gps gps = bd09_To_Gps84(120.672745,30.754398);
        System.out.println(gps.getWgLon()+","+gps.getWgLat());
    }
