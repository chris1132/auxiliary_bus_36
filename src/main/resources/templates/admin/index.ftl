...
<head>
    ...
    <!-- Le styles -->
    <link rel="stylesheet" href="${staticFileDomain!''}/assets/css/style.css">
    <link rel="stylesheet" href="${staticFileDomain!''}/assets/css/loader-style.css">
    <link rel="stylesheet" href="${staticFileDomain!''}/assets/css/bootstrap.css">

    <link rel="stylesheet" type="text/css" href="${staticFileDomain!''}/assets/js/progress-bar/number-pb.css">
    ...
    <!--[if lt IE 9]>
        ...
        <![endif]-->
    <!-- Fav and touch icons -->
    <link rel="shortcut icon" href="${staticFileDomain!''}/assets/ico/minus.png">
</head>
...
<body> 
    ...
    <script type="text/javascript" src="${staticFileDomain!''}/assets/js/jquery.js"></script>
    <script src="${staticFileDomain!''}/assets/js/progress-bar/src/jquery.velocity.min.js"></script>
    <script src="${staticFileDomain!''}/assets/js/progress-bar/number-pb.js"></script>
    <script src="${staticFileDomain!''}/assets/js/progress-bar/progress-app.js"></script>



    <!-- MAIN EFFECT -->
    <script type="text/javascript" src="${staticFileDomain!''}/assets/js/preloader.js"></script>
    <script type="text/javascript" src="${staticFileDomain!''}/assets/js/bootstrap.js"></script>
    <script type="text/javascript" src="${staticFileDomain!''}/assets/js/app.js"></script>
    <script type="text/javascript" src="${staticFileDomain!''}/assets/js/load.js"></script>
    <script type="text/javascript" src="${staticFileDomain!''}/assets/js/main.js"></script>
    ...
    <script type="text/javascript" src="${staticFileDomain!''}/assets/js/chart/jquery.flot.js"></script>
    <script type="text/javascript" src="${staticFileDomain!''}/assets/js/chart/jquery.flot.resize.js"></script>
    <script type="text/javascript" src="${staticFileDomain!''}/assets/js/chart/realTime.js"></script>
    <script type="text/javascript" src="${staticFileDomain!''}/assets/js/speed/canvasgauge-coustom.js"></script>
    <script type="text/javascript" src="${staticFileDomain!''}/assets/js/countdown/jquery.countdown.js"></script>



    <!--<script src="http://www.dzgj.com/assets/js/jhere-custom.js"></script>-->
    ...
    <!--$(window).on('load', function() {-->
        ...
        <!--}).jHERE('marker', [52.500556, 13.338889], {-->
            <!--icon: 'http://www.dzgj.com/assets/img/marker.png',-->
            <!--anchor: {-->
                <!--x: 12,-->
                <!--y: 32-->
            <!--},-->
